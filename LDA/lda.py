...
def performLDA(doclist, stopwords=True, df=0, k=10, alpha=0.5, beta=0.5, smartinit=False, iteration=1):
    #import optparse
    import vocabulary
    import re
    ...
    print "corpus=%d, words=%d, K=%d, a=%f, b=%f" % (len(corpus), len(voca.vocas), k, alpha, beta)
